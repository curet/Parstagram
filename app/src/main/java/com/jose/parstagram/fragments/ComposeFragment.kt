...
class ComposeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Set onClickListeners and setup the logic

        ivPreview = view.findViewById(R.id.at_post_image)

        view.findViewById<Button>(R.id.image_submit_button).setOnClickListener{
            // send post to server
            ...
            if (photoFile != null){
                ...
                Log.e(MainActivity.TAG, "Error while submitting picture")
                Toast.makeText(requireContext(), "Error while submitting picture", Toast.LENGTH_SHORT).show()
